...
import com.example.gacs_wheel.Utils.sincronizarUsuariosBidireccionalCompleto
import com.example.gacs_wheel.Utils.sincronizarVehiculosBidireccionalCompleto
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            sincronizarUsuariosBidireccionalCompleto(this@MainActivity)
            sincronizarVehiculosBidireccionalCompleto(this@MainActivity)
        }
            ...
            Gacs_wheelTheme {
                ...
                Scaffold(modifier = Modifier.fillMaxSize()) {
                    NavHost(
                        ...
                        composable("admin") {
                            AdminVehiculoScreen(navController)
                        }
